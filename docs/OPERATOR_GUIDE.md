...
This is the expanded guide moved out of the short README. It preserves the detailed operator, configuration, recording, dataset, troubleshooting, release, and debug notes for deeper use.
